...
- [x] Gateway goal/plan lifecycle alias endpoints (complete/abandon/supersede convenience actions, user-scoped)
...
- [x] Goal/plan list filtering (`status`, `limit`) in web query params and CLI list commands
- [x] CLI goal/plan lifecycle alias commands (`goal complete|abandon`, `plan complete|supersede`)
