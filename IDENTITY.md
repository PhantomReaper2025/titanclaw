...
- CLI exposes `titanclaw goal` and `titanclaw plan` subcommands (create/list/show) for direct inspection and manual creation of autonomy records in local/single-user workflows.
