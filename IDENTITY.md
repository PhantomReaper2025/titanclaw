...
- Goal/plan list inspection endpoints now support lightweight filtering/limits (`status`, `limit`) for user-scoped dashboard and CLI parity use cases.
