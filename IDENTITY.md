...
- CLI exposes `titanclaw goal`, `titanclaw plan`, and `titanclaw plan-step` subcommands (create/list/show/set-status/replace where applicable) for direct inspection and manual management of autonomy records in local/single-user workflows.
