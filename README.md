...
- Internal runtime control-plane v1 loop components: `PlannerV1`, shared policy-evaluation helpers (dispatcher/worker/approval resume), `VerifierV1` soft completion gate, and bounded automatic worker replanning
