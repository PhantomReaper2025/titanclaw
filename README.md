...
- User-scoped web goal/plan APIs for autonomy inspection + creation (`GET /api/goals`, `GET /api/goals/{id}`, `GET /api/goals/{id}/plans`, `GET /api/plans?goal_id=...`, `GET /api/plans/{id}`, `POST /api/goals`, `POST /api/plans`)
