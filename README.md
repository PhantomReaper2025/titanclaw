...
- CLI autonomy commands: `titanclaw goal {create|list|show|set-status}`, `titanclaw plan {create|list|show|set-status}`, and `titanclaw plan-step {create|replace|list|show|set-status}`
