...
async fn run_task_isolated(params: TaskRunParams<'_>) -> TaskResult {
    ...
    let agent_config = AgentConfig {
        ...
        use_planning: false,
        autonomy_policy_engine_v1: false,
        autonomy_verifier_v1: false,
        autonomy_replanner_v1: false,
        ...
        autonomy_memory_consolidation_interval: std::time::Duration::from_secs(60),
        autonomy_memory_consolidation_batch_size: 50,
        autonomy_memory_working_ttl: std::time::Duration::from_secs(86_400),
        autonomy_memory_episodic_ttl_days: 30,
        autonomy_memory_playbook_min_repetitions: 3,
        session_idle_timeout: timeout,
        swarm_remote_wait_timeout: std::time::Duration::from_millis(500),
        allow_local_tools: true,
        max_cost_per_day_cents: None,
        max_actions_per_hour: None,
        enable_piped_tool_execution: false,
        shadow_workers_enabled: false,
        shadow_max_predictions: 1,
        shadow_cache_ttl: std::time::Duration::from_secs(30),
        shadow_max_parallel: 1,
        shadow_min_input_chars: 10,
        kernel_monitor_enabled: false,
        kernel_monitor_interval: std::time::Duration::from_secs(60),
        kernel_slow_threshold_ms: 5000.0,
        kernel_auto_approve_patches: false,
        kernel_auto_deploy_patches: false,
        profile_synthesis_enabled: false,
        profile_synthesis_debounce: std::time::Duration::from_secs(30),
        profile_synthesis_max_batch_turns: 10,
        profile_synthesis_min_chars: 50,
        profile_synthesis_llm_enabled: false,
    };
